...
import type { roomType, clinicListType } from '@/types/rooms/index';
...
const fetchrooms = async () => {
    try {
        const response = await axios.get('/rooms/clinic', {
            params: {
                id: roomId
            }
        });
        ...
        clinicList.value = response.data.clinics;
        ...
        <v-col cols="12">
            <v-row>
                <v-card elevation="10" class="">
                    ...
                    <div class="d-flex justify-space-between">
                        ...
                        <v-text-field v-model="searchInput" variant="outlined" @input="handleSearchInput" placeholder="検索キーワードを入力してください" append-inner-icon="mdi-magnify" style="max-width: 300px;"></v-text-field>
                        <div>
                    ...
                    <v-table class="month-table">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in (filteredRooms.length ? filteredRooms : []).slice((currentPage-1) * 10, currentPage * 10)" :key="item.id" class="month-item">
                                <td>
            ...
            <v-dialog v-model="isModalOpen" max-width="600px">
                ...
                <v-card-text>
                    ...
                    <v-row>
                        <v-col cols="12">
                            <v-text-field v-model="newRoom.name" label="名称" variant="outlined"></v-text-field>
                        </v-col>
                        <v-col cols="12">
